...
export function MobileSidebar() {
  ...
  return (
    <div className="lg:hidden">
      ...
      >
        <div className="flex h-16 items-center justify-between gap-3 px-6 border-b">
        ...
        <div className="border-t p-4 text-center text-[11px] font-medium text-[hsl(var(--muted-foreground))] bg-[hsl(var(--muted))]/30">
